  ...
  const getHintDisplay = (word, level) => {
    ...
    if (level === 4) {
      ...
      const pattern = originalWord.split('').map((char, i) => {
        ...
        return '·'; // Use middle dot instead of underscore for better spacing
        ...
        {!gameWon && (
          <div className="bg-white rounded-lg shadow-lg p-6 mb-6">
            ...
            <p className="text-sm text-gray-600 mt-2">
              💡 Tip: Click on any redacted word repeatedly to reveal progressive hints:<br/>
              <strong>1st click:</strong> Length • <strong>2nd click:</strong> First letter • <strong>3rd click:</strong> First & last letter • <strong>4th click:</strong> Vowel pattern
            </p>
          </div>
        )}
